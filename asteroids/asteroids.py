...
class TurningSprite(arcade.Sprite):
    ...
    def update(self):
        super().update()
        # print(f"dx:[{self.change_x}] - dy:[{self.change_y}]")
...
class MyGame(arcade.Window):
    ...
    def start_new_game(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = ShipSprite("images/playerShip2_blue.png", SCALE)
        ...
        for i in range(self.lives):
            life = arcade.Sprite("images/playerLife1_blue.png", SCALE)
    ...
    def on_mouse_press(self, x, y, button, mods):
        # print(f"MouseX:[{button}]")
        if button == arcade.MOUSE_BUTTON_RIGHT:
            self.player_sprite.change_angle = -6    # CW
        if button == arcade.MOUSE_BUTTON_LEFT:
            self.player_sprite.change_angle = 6     # CCW
